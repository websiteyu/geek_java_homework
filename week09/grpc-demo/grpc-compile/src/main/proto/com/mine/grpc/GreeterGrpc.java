...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<DemoProto.HelloRequest,
      DemoProto.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = DemoProto.HelloRequest.class,
      responseType = DemoProto.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<DemoProto.HelloRequest,
      DemoProto.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<DemoProto.HelloRequest, DemoProto.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<DemoProto.HelloRequest, DemoProto.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  DemoProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  DemoProto.HelloReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<DemoProto.HelloRequest,
      DemoProto.HelloReply> getSayHelloAgainMethod;
  ...
  public static io.grpc.MethodDescriptor<DemoProto.HelloRequest,
      DemoProto.HelloReply> getSayHelloAgainMethod() {
    io.grpc.MethodDescriptor<DemoProto.HelloRequest, DemoProto.HelloReply> getSayHelloAgainMethod;
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(DemoProto.HelloRequest request,
                         io.grpc.stub.StreamObserver<DemoProto.HelloReply> responseObserver) {
     ...
     * </pre>
     */
    public void sayHelloAgain(DemoProto.HelloRequest request,
                              io.grpc.stub.StreamObserver<DemoProto.HelloReply> responseObserver) {
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                DemoProto.HelloRequest,
                DemoProto.HelloReply>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
     ...
     * </pre>
     */
    public DemoProto.HelloReply sayHello(DemoProto.HelloRequest request) {
     ...
     * </pre>
     */
    public DemoProto.HelloReply sayHelloAgain(DemoProto.HelloRequest request) {
      return blockingUnaryCall(
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<DemoProto.HelloReply> sayHello(
        DemoProto.HelloRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<DemoProto.HelloReply> sayHelloAgain(
        DemoProto.HelloRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((DemoProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<DemoProto.HelloReply>) responseObserver);
          break;
        case METHODID_SAY_HELLO_AGAIN:
          serviceImpl.sayHelloAgain((DemoProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<DemoProto.HelloReply>) responseObserver);
          break;
        default:
