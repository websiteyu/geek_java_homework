package com.mine.gateway;


import com.mine.gateway.inbound.HttpInboundServer;
import com.mine.register.netty.NettyHttpRegisterServer;
...
//        Thread registerDaemon = new Thread(()-> {
//            try {
//                NettyHttpRegisterServer.listenRegisterServer();
//            } catch (InterruptedException e) {
//                e.printStackTrace();
//            }
//        });
//        registerDaemon.setDaemon(true);
//        registerDaemon.start();
        try {
            server.run();
        }catch (Exception ex){
            ex.printStackTrace();
